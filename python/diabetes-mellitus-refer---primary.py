...
codes = [{"code":"8H7C.00","system":"readv2"},{"code":"8H7f.00","system":"readv2"},{"code":"8HTk.00","system":"readv2"},{"code":"8Hj0.00","system":"readv2"},{"code":"8Hl1.00","system":"readv2"},{"code":"8Hl4.00","system":"readv2"},{"code":"L0010EI","system":"readv2"},{"code":"ZL62500","system":"readv2"},{"code":"ZL62600","system":"readv2"}];
REQUIRED_CODES = 1;
