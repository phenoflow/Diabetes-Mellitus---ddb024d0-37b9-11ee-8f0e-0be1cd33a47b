...
steps:
  ...
  diabetes-mellitus-microalbuminuria---primary:
    run: diabetes-mellitus-microalbuminuria---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-mellitus-review---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-microalbuminuria---primary/output
  ...
  diabetes-mellitus-onset---primary:
    run: diabetes-mellitus-onset---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-mellitus-onset---primary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
